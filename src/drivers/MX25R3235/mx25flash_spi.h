...
#ifdef MX25R3235F
#define    FlashID          0xc22816
#define    ElectronicID     0x16
#define    RESID0           0xc216
#define    RESID1           0x16c2
#define    FlashSize        0x400000       // 4 MB
#define    CE_period        62500000       // tCE /  ( CLK_PERIOD * Min_Cycle_Per_Inst *One_Loop_Inst)
...
#define    DUMMY_CONF_2READ       0x0406080A
#define    DUMMY_CONF_4READ       0x0604080A
#define    DUMMY_CONF_FASTREAD    0x0806080A
#define    DUMMY_CONF_DREAD       0x0806080A
#define    DUMMY_CONF_QREAD       0x0806080A
